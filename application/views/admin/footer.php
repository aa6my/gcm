	...
	<div id="footer" class="no-print">
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<p class="text-center">&copy; <?php echo date('Y'); ?> <?php echo $this->lang->line('footer_footerCopyright'); ?></p>
				</div>
				<div class="col-md-4">
					<p class="text-center"><a href="index.php"><img alt ="clientResponse" src="<?php echo base_url();?>assets/images/footer_logo.png" /></a></p>
				</div>
				<div class="col-md-4">
            ...
            <script type='text/javascript' src='<?php echo base_url();?>assets/jquery/jquery-1.8.1.min.js'></script>
            <script type='text/javascript' src='<?php echo base_url();?>assets/jquery/jquery-ui-1.8.23.custom.min.js'></script>

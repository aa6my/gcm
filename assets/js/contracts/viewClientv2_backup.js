                ...
                var j = $.parseJSON(json);
                   $.each(j,function(i, item){
                      ...
                      if(typeof item == 'object'){
                           selsalestaff.append($("<option />").val(item.adminId).text(item.adminFirstName + " " + item.adminLastName));
                           selsvcstaff.append($("<option />").val(item.adminId).text(item.adminFirstName + " " + item.adminLastName));
                      }
                   }) 
